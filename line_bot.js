...
const SCENARIOS_DATA = {
  ...
  'SC-PARENT': [
    { stepNum: 0, delayDays: 0, sendHour: 8, trackingTag: 'read_p0',
      message: 'はじめまして、翔也です。\n\nお子さんを塾に通わせていても\nリスニングだけが伸びない。\n\nそういうお話を\n保護者の方からよく伺います。\n\nこれ、塾の指導が悪いわけでも\nお子さんの努力が足りないわけでもありません。\n\n日本語と英語では\n音そのものの作り方が違うんです。\n\nそこに気づかないまま\n単語と文法だけを積み上げていく。\n\nだから時間をかけても\n耳だけが置いていかれてしまう。\n\nまずはその「音の正体」を\nお子さんと一緒に体験できる場所から\n見ていただけたらと思います。\n\n▼ 無料体験 Day 1\nhttps://sho-blog.com/all/trial/trial_day1.html' },
    { stepNum: 1, delayDays: 2, sendHour: 8, trackingTag: 'read_p1',
      message: 'おはようございます、翔也です。\n\n昨日の続きを少しだけ。\n\n「water」という単語。\n\nお子さんは\n「ウォーター」と読んでいるはずです。\n\nでも本物の音は「ワラ」に近い。\n\ntの音が日本語のラ行のように\n軽く弾かれる現象が起きています。\n\n知っている単語のはずなのに\n聴こえない。\n\nその正体は単語力ではなく\n音の設定のずれだったんです。\n\nここに気づくだけで\nお子さんの聴こえ方は変わり始めます。\n\n▼ 無料体験 Day 2\nhttps://sho-blog.com/all/trial/trial_day2.html' },
    { stepNum: 2, delayDays: 3, sendHour: 8, trackingTag: 'read_p2',
      message: '英語学習で一番むずかしいのは\n「続けること」だと思っています。\n\n最初の数日はやる気が出ても\n一週間、一か月と経つうちに\nだんだん遠ざかっていく。\n\nお子さん本人の意思だけで\n続けるのは正直むずかしいです。\n\nだからsho eigoの保護者プランでは\n保護者の方に向けて\n毎週「学習レポート」をお送りしています。\n\nお子さんが今週どこまで進み\nどんな音でつまずいているのか。\n\n数字と短いコメントで\n手元に届く仕組みです。\n\n中身がイメージしづらいと思うので\nサンプルを用意しました。\n\n▼ 保護者プラン報告書のサンプル\nhttps://sho-blog.com/parent/report.html' },
    { stepNum: 3, delayDays: 4, sendHour: 8, trackingTag: 'read_p3',
      message: '保護者の方から\nいただいた声を少しだけ\n共有させてください。\n\n「家で英語の話題が\n増えるようになった」\n\n「テストの点よりも\n本人の表情が変わった」\n\n「自分から机に向かう日が\n出てきた」\n\nどれも大きな出来事ではなくて\n日常の小さな変化です。\n\nでも、リスニングが\n少しずつ聴こえ始めると\n本人の中で\n英語が「自分のもの」に\n変わっていくようです。\n\nそのきっかけは\nやはり最初の音の体験でした。\n\n▼ お子さんに体験させる\nhttps://sho-blog.com/all/trial/trial_day1.html' },
    { stepNum: 4, delayDays: 6, sendHour: 8, trackingTag: 'read_p4',
      message: '少し前にお伝えした\n学習レポートの中身を\nもう少し具体的にお見せします。\n\n・今週の学習時間\n・取り組んだ音のテーマ\n・つまずいた箇所と原因\n・来週の重点ポイント\n\nこの4つが\n見開きでまとまる形にしています。\n\n保護者の方が\nお子さんに声をかけるときに\n「何を聞いたらいいか分からない」\nという状態をなくしたかったんです。\n\nレポートを開けば\n話のきっかけが必ず1つは見つかる。\n\nそんな道具として\n使っていただけたらと思っています。\n\n▼ 保護者プランの詳細\nhttps://sho-blog.com/all/trial/next_step_day2.html' },
    { stepNum: 5, delayDays: 7, sendHour: 8, trackingTag: 'read_p5', skipIfTag: 'purchased',
