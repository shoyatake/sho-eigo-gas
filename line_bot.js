...
const SCENARIOS_DATA = {
  ...
  'SC-ADULT': [
    { stepNum: 0, delayDays: 0, sendHour: 8, trackingTag: 'read_a0',
      message: 'はじめまして、翔也です。\n\n社会人の英語学習で\n一番むずかしいのは\n「時間の確保」だと思います。\n\nでも実は\n1日15〜20分あれば\n音は変わっていきます。\n\n通勤電車の20分。\n昼休みの15分。\n寝る前の10分。\n\n机に向かわなくても\nイヤホンさえあればできるのが\n音の練習のいいところです。\n\nまずは1日分\n試してみてください。\n\n▼ 20分で体験できます\nhttps://sho-blog.com/all/trial/trial_day1.html' },
    { stepNum: 1, delayDays: 2, sendHour: 8, trackingTag: 'read_a1',
      message: 'おはようございます。\n\n社会人の学習でよく聞くのが\n「3日で続かなくなる」という話です。\n\n原因はやる気ではなく\n「やる場所と時間が決まっていない」\nことがほとんどです。\n\n通勤の行きの電車だけ。\n歯磨きのあとだけ。\n\nこうやって\n生活の中の決まった瞬間に\n紐づけてしまうと\n意志の力に頼らずに済みます。\n\n昨日の続きを\n通勤のついでにどうぞ。\n\n▼ Day 2 はこちら\nhttps://sho-blog.com/all/trial/trial_day2.html' },
    { stepNum: 2, delayDays: 4, sendHour: 8, trackingTag: 'read_a2',
      message: '受講生の方からよく届く\n感想があります。\n\n「ある日、映画の台詞が\n勝手に聴こえてきた」\n\nテキストを開いていたわけでも\n集中して聴いていたわけでもなく\n流していた洋画のセリフが\nふと耳に入ってきた、という話です。\n\n音の土台ができてくると\nこういう瞬間が\n少しずつ増えていきます。\n\n派手な変化ではないのですが\nこれが本物の積み上がりです。\n\nまだの方は\nここから音の入り口へ。\n\n▼ 体験はこちら\nhttps://sho-blog.com/all/trial/trial_day1.html' },
    { stepNum: 3, delayDays: 6, sendHour: 8, trackingTag: 'read_a3',
      message: '会議の英語。\n電話の英語。\n\nこの二つが苦手という方は\n本当に多いです。\n\n対面と違って\n口の動きが見えない。\n聞き返しづらい雰囲気もある。\n\nここで効くのが\n「音そのものを\n正しく拾えるかどうか」です。\n\n単語を知っていても\n音の形が違うと\n脳は知らない単語として\n処理してしまいます。\n\n逆に音の設定が合えば\n知っている単語は\nちゃんと聴こえるようになります。\n\n仕事で使う英語ほど\n土台の音が効いてきます。\n\n▼ 次のステップはこちら\nhttps://sho-blog.com/all/trial/next_step_day2.html' },
    { stepNum: 4, delayDays: 8, sendHour: 8, trackingTag: 'read_a4',
      message: '「いつかちゃんとやろう」\n\nこの言葉で\n3年、5年と過ぎていく方を\n何人も見てきました。\n\n社会人の学習は\n気合いではなく\n仕組みで続けるものだと思います。\n\n・週に何回やるかを決める\n・どの時間帯にやるかを決める\n・できなかった日は責めずに翌日に回す\n\nこの三つを決めるだけで\n半年後の景色が変わります。\n\n始めるなら\n忙しい今がちょうどいいです。\n暇になってから始めた人を\n見たことがないので。\n\n▼ 続け方の設計はこちら\nhttps://sho-blog.com/all/trial/next_step_day2.html' },
    { stepNum: 5, delayDays: 10, sendHour: 8, trackingTag: 'read_a5', skipIfTag: 'purchased',
